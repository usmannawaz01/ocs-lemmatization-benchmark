...
An interactive demo is available as a Hugging Face Space: [OCS Combined Lemmatizer Demo](https://huggingface.co/spaces/usmannawaz/ocs-combined-lemmatizer-demo). 
